...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        //All About Caching in .NET – A Beginner’s Guide!    https://youtu.be/PpKEcbTrR4w?t=597 //https://youtu.be/PpKEcbTrR4w?t=716
        //Docker Instance: "local-redis"
        //https://hub.docker.com/_/redis
        //https://open.docker.com/extensions/marketplace?extensionId=virag/redis-enterprise-docker-extension
